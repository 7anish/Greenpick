                    ...
                    <div class="w-full flex  flex-col lg:flex-row lg:items-center lg:justify-between">
                        ...
                        <div class="hidden w-full lg:flex lg:pl-11 " id="navbar-default">
                            <ul class="lg:flex items-center flex-col mt-4 lg:mt-0 lg:flex-row lg:ml-auto gap-4">
                                <li>
                                    <NavLink to={'/'} class="nav-link mb-2 block lg:mr-6 md:mb-0 lg:text-left text-center">Home</NavLink>
                                </li>
                                <li>
                                    <NavLink to={'/pricing'} class="nav-link mb-2 block lg:mr-6 md:mb-0 lg:text-left text-center">Pricing</NavLink>
                                </li>
                            </ul>
                            <div class="flex items-center ml-5 justify-center">
                                ...
                                <button
                                    class="bg-green-600 text-white rounded-full cursor-pointer font-semibold text-center shadow-xs transition-all duration-500 py-3 px-6 text-sm md:ml-5 hover:bg-green-700">Sign
                                    up </button>
                            </div>
                        </div>
                    </div>
