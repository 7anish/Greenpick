...
const Chatbox = () => {
    ...
    const onSendButton = async () => {
        ...
        try {
            const response = await fetch('https://15fe-2409-40d2-1337-1e89-b884-9f7e-58a8-81ad.ngrok-free.app/predict', {
                method: 'POST',
    ...
    const renderMessages = () => {
        return messages
            ...
            .map((msg, index) => (
                <div
                    key={index}
                    className={`messages__item ${msg.name === 'GreenPick' ? 'messages__item--visitor' : 'messages__item--operator'
                        }`}
                >
                    {msg.message}
                </div>
            ...
            >
                ...
                <div className="chatbox__header">
                    ...
                    <div className="chatbox__content--header">
                        <h1 className='absolute right-5 top-5 cursor-pointer' onClick={toggleState}>
